...
11. Open the email and review the contents. Scroll to the bottom of the email and select the **View alert details** button. This opens the **Security and Compliance Center**, displays the **View alerts** window, and opens the **Mailbox permission change** alert.If not, in your browser, enter **https://protection.office.com**, select **Alert** in the left hand navigation pane and select View Alert. <br/>
