# Lab 3 - Exercise 3 - Prepare for Alert Policies
...
2. After finishing the previous lab, you should still be in the **Microsoft 365 admin center** in your browser. In the left-hand navigation pane, select **Show all**, and then under the **Admin centers** group, select **Security**.If not, in your browser, enter** https://protection.office.com**.
